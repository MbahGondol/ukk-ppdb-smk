...
@section('header', 'Edit Data Harga')
...
<div class="max-w-2xl mx-auto">
    <div class="bg-white shadow overflow-hidden sm:rounded-lg">
        <div class="px-4 py-5 sm:px-6 bg-gray-50 border-b border-gray-200">
            ...
            <p class="mt-1 max-w-2xl text-sm text-gray-500">Perbarui nominal atau kategori biaya.</p>
        </div>
            ...
            <form action="{{ route('admin.biaya.update', $harga->id) }}" method="POST">
                ...
                <div class="mb-6">
                    ...
                    <textarea name="catatan" rows="3" 
                              class="shadow-sm focus:ring-blue-500 focus:border-blue-500 block w-full sm:text-sm border-gray-300 rounded-md p-2 border">{{ old('catatan', $harga->catatan) }}</textarea>
                </div>

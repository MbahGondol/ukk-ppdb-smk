...
@section('title', 'Tambah Tipe Biaya')
@section('header', 'Tambah Tipe Biaya Baru')

@section('content')
<div class="max-w-2xl mx-auto">
    <div class="bg-white shadow overflow-hidden sm:rounded-lg">
        <div class="px-4 py-5 sm:px-6 bg-gray-50 border-b border-gray-200">
            <h3 class="text-lg leading-6 font-medium text-gray-900">Form Tipe Biaya</h3>
            <p class="mt-1 max-w-2xl text-sm text-gray-500">Buat kategori biaya baru (contoh: SPP, Uang Gedung).</p>
        </div>
            ...
            <form action="{{ route('admin.jenis-biaya.store') }}" method="POST">
                ...
                <div class="mb-6">
                    ...
                    <textarea name="keterangan" id="keterangan" rows="3" 
                              class="shadow-sm focus:ring-blue-500 focus:border-blue-500 block w-full sm:text-sm border-gray-300 rounded-md p-2 border"
                              placeholder="Deskripsi singkat tentang biaya ini">{{ old('keterangan') }}</textarea>
                </div>

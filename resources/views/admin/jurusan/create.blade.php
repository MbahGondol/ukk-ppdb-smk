...
<div class="max-w-2xl mx-auto">
    <div class="bg-white shadow overflow-hidden sm:rounded-lg">
        <div class="px-4 py-5 sm:px-6 bg-gray-50 border-b border-gray-200">
            <h3 class="text-lg leading-6 font-medium text-gray-900">Form Data Jurusan</h3>
            <p class="mt-1 max-w-2xl text-sm text-gray-500">Isi detail jurusan yang ingin ditambahkan.</p>
        </div>
            ...
            <form action="{{ route('admin.jurusan.store') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="kode_jurusan" id="kode_jurusan" value="{{ old('kode_jurusan') }}" 
                           ...
                           placeholder="Contoh: RPL, TKR" required>
                </div>
                ...
                <div class="mb-6">
                    ...
                    <textarea name="deskripsi" id="deskripsi" rows="3" 
                              class="shadow-sm focus:ring-blue-500 focus:border-blue-500 block w-full sm:text-sm border-gray-300 rounded-md p-2 border">{{ old('deskripsi') }}</textarea>
                </div>

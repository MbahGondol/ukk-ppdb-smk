...
<body class="h-full font-sans antialiased">
    ...
    <div class="min-h-screen flex">
        ...
        <aside class="w-64 bg-blue-800 text-white flex flex-col flex-shrink-0 transition-all duration-300">
            
            <div class="h-16 flex items-center justify-center border-b border-blue-700 bg-blue-900">

...
<div class="max-w-4xl mx-auto pb-10">
    ...
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="{{ route('siswa.dashboard') }}" class="text-gray-600 hover:text-blue-600 font-medium flex items-center">
    ...
    <div class="bg-white shadow-lg rounded-lg overflow-hidden border border-gray-200">
        ...
        <div class="px-6 py-4 bg-blue-600 border-b border-gray-200 flex justify-between items-center">
            <span class="text-white font-bold text-lg">Data Diri & Akademik</span>
            <span class="bg-white text-blue-600 text-xs font-bold px-3 py-1 rounded-full uppercase">
        ...
        <div class="p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="bg-green-50 p-4 rounded-lg border border-green-100">
                        ...
                        @if($siswa->promo)
                            ...
                            <span class="block text-sm text-green-600 mt-1">
                                (Potongan Biaya: Rp {{ number_format($siswa->promo->potongan, 0, ',', '.') }})
                            </span>
                        @else
                            <span class="font-medium text-gray-600 italic">
            ...
            <div class="mb-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-y-4 gap-x-8">
                    <div><span class="text-sm text-gray-500 block">No. Pendaftaran</span> <span class="font-bold text-blue-600">{{ $siswa->no_pendaftaran }}</span></div>
            ...
            <div class="mb-8 bg-blue-50 p-4 rounded-lg border border-blue-100">
                <h3 class="text-lg font-bold text-blue-800 mb-2">Pilihan Jurusan</h3>
                ...
                <div class="grid grid-cols-1 gap-6">
                    @foreach ($siswa->penanggungJawab as $pj)
                        <div class="border rounded-lg p-4 bg-gray-50 relative">
                            <span class="absolute top-0 right-0 bg-gray-200 text-gray-700 text-xs font-bold px-2 py-1 rounded-bl-lg uppercase">
                                {{ $pj->hubungan }}
                            </span>
